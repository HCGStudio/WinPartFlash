...
#   APPLE_NOTARY_USER            Apple ID email used to submit to notarytool
...
for var in APPLE_DEVELOPER_ID_NAME APPLE_TEAM_ID APPLE_NOTARY_USER APPLE_NOTARY_PASSWORD; do
    eval "value=\$$var"
    if [ -z "$value" ]; then
